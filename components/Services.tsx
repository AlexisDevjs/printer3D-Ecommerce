...
export default function Services() {
  const services = [
    {
      title: "Modelado 3D",
      description: "Diseñamos tus ideas en 3D",
      icon: Cube,
    },
    {
      title: "Cotización",
      description: "Obtén un presupuesto al instante",
      icon: Calculator,
    },
    {
      title: "Adquisición",
      description: "Compra productos pre-impresos",
      icon: ShoppingCart,
    },
  ];
          ...
          {services.map((service, index) => (
            ...
            >
              <CardHeader>
                ...
                <CardTitle className="text-[#1a5e9d]">
                  {service.title}
                </CardTitle>
